                ...
                {promptTemplates.map((template, index) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative flex items-center space-x-3 p-4 rounded-2xl bg-white hover:bg-white/90 native-transition text-left group shadow-md ${template.shadow} hover:shadow-lg overflow-hidden`}
                    >
          ...
          <div className="p-4">
            <div className="flex items-center space-x-3">
              ...
              <button
                ...
                disabled={!input.trim()}
                className="w-12 h-12 rounded-full bg-gradient-to-r from-rose to-burgundy text-white flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed native-transition ios-active shadow-2xl shadow-rose/50 ring-2 ring-burgundy/60"
              >
