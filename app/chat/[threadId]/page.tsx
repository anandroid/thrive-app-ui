...
export default function ChatPage({ params }: { params: Promise<{ threadId: string }> }) {
  ...
  return (
    <div className="app-screen bg-gray-50">
      ...
      {/* Header */}
      <div className="app-header backdrop-blur-xl bg-white/90 border-b border-gray-200 shadow-lg">
        <div className="flex items-center justify-between px-4 h-14">
          <Link 
            href="/"
            className="w-11 h-11 rounded-2xl flex items-center justify-center hover:bg-gray-100 native-transition shadow-md"
          >
            <ArrowLeft className="w-5 h-5 text-gray-700" />
          </Link>
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-rose to-burgundy flex items-center justify-center shadow-md">
